      ...
      >
        ...
        <div class="stat-content">
          ...
          <div class="stat-change" :class="stat.trend">
            <component :is="stat.trend === 'up' ? TrendingUp : TrendingDown" :size="14" />
            {{ stat.change }}
          </div>
        </div>
      </div>
      ...
      <div class="content-card glass-card slide-up stagger-5">
        <div class="card-header">
          <div class="header-left">
            <BookOpen :size="20" class="header-icon" />
            <h3>{{ t('recent_borrowings') }}</h3>
          </div>
          <button class="view-all-btn" @click="goToBorrowings">
            {{ t('view_all') }}
            <ArrowRight :size="16" />
          </button>
        </div>
